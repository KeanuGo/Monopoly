...
public class Monopoly{
	...
	public static void showGame(){
		...
		//System.out.println(gameHandler.board.getSize());
		gameHandler.playerStatusPanel.setLocation(gameHandler.board.getWidth()+5, 5);
		...
		gameHandler.forexStatusPanel.setLocation(gameHandler.board.getWidth()+270, gameHandler.playerStatusPanel.getHeight()+10);
		gameHandler.forexStatusPanel.setSize(385, (int)gameHandler.forexStatusPanel.getPreferredSize().getHeight()+15);
		gameHandler.currencyExchangePanel.setLocation(gameHandler.board.getWidth()+270, gameHandler.playerStatusPanel.getHeight()+gameHandler.forexStatusPanel.getHeight()+ 15);
		gameHandler.currencyExchangePanel.setSize(gameHandler.currencyExchangePanel.getPreferredSize());
		gameHandler.roll_dice_button.setLocation(gameHandler.board.getWidth()+5, gameHandler.playerStatusPanel.getHeight()+ gameHandler.currencyExchangePanel.getHeight() + 30);
		...
		gameHandler.current_turn_label.setLocation(gameHandler.board.getWidth()+10, gameHandler.playerStatusPanel.getHeight()+20);
		...
		gameHandler.dice_icon_label[0].setLocation(gameHandler.board.getWidth()+105, gameHandler.playerStatusPanel.getHeight()+ gameHandler.currencyExchangePanel.getHeight() + 30);
		gameHandler.dice_icon_label[1].setLocation(gameHandler.board.getWidth() + gameHandler.dice_icon_label[0].getWidth() + 115, gameHandler.playerStatusPanel.getHeight()+ gameHandler.currencyExchangePanel.getHeight() + 30);
